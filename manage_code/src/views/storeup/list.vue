		...
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button class="view_btn"  v-if=" btnAuth('storeup','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">
						<i class="iconfont icon-sousuo3"></i>
						详情
					</el-button>
					<el-button class="edit_btn" type="primary" :disabled="selRows.length==1?false:true" @click="editClick()" v-if=" btnAuth('storeup','修改')">

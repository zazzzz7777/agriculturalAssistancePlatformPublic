					...
					<el-row>
						<el-col :span="24">
							<el-form-item prop="account" label="账号">
								<el-input class="list_inp" v-model="userForm.account" placeholder="账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item prop="password" label="密码">
								<el-input class="list_inp" v-model="userForm.password" placeholder="密码" type="password"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item prop="headportrait" label="头像">
								<uploads
									...
									:fileUrls="userForm.headportrait?userForm.headportrait:''" 
						...
						<el-col :span="24">
							<el-form-item prop="name" label="姓名">
								<el-input class="list_inp" v-model="userForm.name" placeholder="姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
						...
						<el-col :span="24">
							<el-form-item prop="mobilenumber" label="手机号码">
								<el-input class="list_inp" v-model="userForm.mobilenumber" placeholder="手机号码" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item prop="idnumber" label="身份证号码">
								<el-input class="list_inp" v-model="userForm.idnumber" placeholder="身份证号码" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet('headportrait',res.data.data.headportrait)
	...
	const updatePassword = async ()=>{
		passwordFormRef.value.validate(async (valid) => {
			if (valid) {
				if(passwordForm.value.mima != userForm.value.password){
				...
				userForm.value.password = passwordForm.value.newmima
	...
	const updateSession = () => {
		userFormRef.value.validate((valid)=>{
			if(valid){
				if(userForm.value.headportrait!=null){
					userForm.value.headportrait = userForm.value.headportrait.replace(new RegExp(context?.$config.url,"g"),"");
				}
				store.dispatch('user/update',userForm.value).then(res=>{
					if(res?.data&&res.data.code==0){
						context?.$toolUtil.message('更新成功','success')
...
.center_view .section_title{
    background: linear-gradient(0deg, rgb(254, 177, 66) 0%, rgb(254, 177, 66) 50%, rgb(255, 247, 236) 50%, rgb(255, 247, 236) 100%);
    color: rgb(51, 51, 51);
    height:50px;
    line-height:50px;
    text-align:center;
